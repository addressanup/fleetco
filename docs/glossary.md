...
**Driver** is an employed or contracted person who operates vehicles on trips. Drivers have license metadata and an employment status (active, on leave, terminated). Drivers are participants in trips; they are not the central aggregate.
